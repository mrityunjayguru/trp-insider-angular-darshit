  ...
  compoundVariants: [
    {
      zActivePosition: 'top',
      isActive: true,
      class: 'border-t-2 text-[#006842] hover:text-[#006842] border-t-primary',
    },
    {
      zActivePosition: 'bottom',
      isActive: true,
      class: 'border-b-2 text-[#006842] hover:text-[#006842] border-b-primary',
    },
    {
      zActivePosition: 'left',
      isActive: true,
      class: 'border-l-2 text-[#006842] hover:text-[#006842] border-l-primary',
    },
    {
      zActivePosition: 'right',
      isActive: true,
      class: 'border-r-2 text-[#006842] hover:text-[#006842] border-r-primary',
    },
  ],
  defaultVariants: {
    zActivePosition: 'bottom',
